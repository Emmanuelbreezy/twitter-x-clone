  ...
  return (
    <div className="flex flex-col items-center h-auto lg:h-full">
      <main className="w-full h-full">
        <div className="w-full flex flex-row-reverse items-center h-full">
          <div className="flex-shrink flex-1 min-w-[437px] max-w-[760px] h-full p-4 flex flex-col">
            ...
            <div className="w-[300px] ">
              ...
              <div className="sign_divder_line flex flex-row items-center w-[300px] max-w-[380px] -mx-1 my-1">
          ...
          <div className="flex-[1.2] min-[45vh]">
            <svg
              viewBox="0 0 24 24"
              aria-hidden="true"
